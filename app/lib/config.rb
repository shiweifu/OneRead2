module Config
  ...
  def Config.menu_items
    ...
    if daily_list.empty? and rss_list.empty? and rss_list.empty?
      ...
      daily_list << {url: 'https://coding.net/u/shiweifu/p/OneReadRouter/git/raw/master/mono.r', name: 'Mono'}
      daily_list << {url: 'https://coding.net/u/shiweifu/p/OneReadRouter/git/raw/master/dgtle.r', name: '数字尾巴'}
